const philosophers = [
  {
    ...
    sources: ["República (Libros VI-VII)", "Fedón", "Banquete"],
  },
  {
    name: "Aristóteles",
    era: "Liceo de Atenas",
    ...
    insomnia: "Se preguntaba qué hace que una vida sea plenamente feliz.",
    advice: "Construye hábitos virtuosos con pequeñas acciones diarias.",
    sources: ["Ética a Nicómaco", "Metafísica", "Física"],
  },
];
...
function renderPhilosophers(list) {
  ...
  if (!container) {
    console.error("No encuentro #philosopher-cards en index.html");
    return;
  }
